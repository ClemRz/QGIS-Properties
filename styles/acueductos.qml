...
<qgis version="2.6.1-Brighton" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="RELA_SUELO">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{4c2dd879-9aa2-4c8a-a1f7-e1a53a729f68}">
      <rule filter="upper(RELA_SUELO) != 'SUBTERRNEO'" key="{a08b3ae2-d848-44af-8330-6407abd3636e}" symbol="0" label="Acueducto superficial"/>
      <rule filter="upper(RELA_SUELO) = 'SUBTERRNEO'" key="{89c20501-e84b-41ff-b523-cf679bce67bf}" symbol="1" label="Acueducto subterraneo"/>
    </rules>
    <symbols>
