...
<qgis version="2.6.1-Brighton" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{86dfd55d-1036-4e60-9f18-323fd1d8626c}">
      <rule filter="strpos(upper(TIPO), 'MICROONDAS') != -1" key="{a14ba984-d130-4362-ba5c-8e330d56bae4}" symbol="0" label="Instalación de telecomunicaciones"/>
      <rule filter="strpos(upper(TIPO), 'MICROONDAS') = -1" key="{dceefedc-3123-4e59-b525-ff7fcaa0b758}" symbol="1" label="Instalación de comunicaciones"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="name" v="instalacion_de_comunicaciones.svg"/>
          <prop k="offset" v="0,0"/>
      ...
      <symbol alpha="1" type="marker" name="1">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="estacion_de_telecomunicaciones.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="#000000"/>
