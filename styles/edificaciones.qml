...
<qgis version="2.12.1-Lyon" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{c0b163ae-12a9-4ec9-a73b-a1aa9c3701af}">
      <rule filter="upper(TIPO) = 'OTRO' OR upper(TIPO) = 'GRANJA O ESTABLO'" key="{29a248ed-0801-48e1-8365-36b36f4bd799}" symbol="0" label="Edificacion aislada"/>
      <rule filter="upper(TIPO) = 'CENTRO DE ASISTENCIA MDICA'" key="{143d0c40-1216-46d8-b111-a387dc348129}" symbol="1" label="Servicio medico"/>
      <rule scalemaxdenom="27000" filter="upper(TIPO) = 'ESCUELA' AND strpos(upper(NOMBRE), '(PRIMARIA|SECUNDARIA|COLEGIO|BACHILERATO)') != -1" key="{501380e7-aceb-475f-829f-ffa81d62f541}" symbol="2" scalemindenom="1" label="Escuela nivel basico"/>
      <rule scalemaxdenom="27000" filter="upper(TIPO) = 'ESCUELA' AND strpos(upper(NOMBRE), '(INSTITUTO|TECNOLOGICO|UNIVERSIDAD)') != -1" key="{d69deb47-c27e-46f9-9d40-fc164966ee7d}" symbol="3" scalemindenom="1" label="Escuela nivel medio y superior"/>
      <rule scalemaxdenom="27000" filter="upper(TIPO) = 'TEMPLO'" key="{c8b5d3a0-67b2-4624-9954-182cebf52796}" symbol="4" scalemindenom="1" label="Templo"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="name" v="edificacion_aislada.svg"/>
          <prop k="offset" v="0,0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="2">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="color" v="0,0,0,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="escuela_nivel_basico.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="3">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="color" v="0,0,0,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="escuela_nivel_medio_y_superior.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="255,255,255,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="CASE WHEN upper(NOMBRE) != 'NINGUNO' THEN title( Nombre) END "/>
