...
<qgis version="2.18.24" simplifyAlgorithm="0" minimumScale="0" maximumScale="30000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{f23eab48-40fa-4f76-9af2-394714759aad}">
      <rule filter="toint(elevation) % 100 = 0" key="{84d12d9a-2168-4734-91b2-1e1ca1092dee}" symbol="0" label="Curva de nivel maestra"/>
      <rule filter="toint(elevation) % 100 != 0 AND toint(elevation) % 50 = 0" key="{54e390bd-f61d-404c-a0d5-0050eb076a2a}" symbol="1" label="Curva de nivel ordinaria (50m)"/>
      <rule scalemaxdenom="30000" filter="toint(elevation) % 100 != 0 AND toint(elevation) % 50 != 0" key="{1af18c7b-f4ea-464e-9abb-2cd6eedf5fc7}" symbol="2" scalemindenom="1" label="Curva de nivel ordinaria (5m)"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="123,83,60,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.34483"/>
      ...
      <symbol alpha="0.298039" clip_to_extent="1" type="line" name="2">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="CASE WHEN toint(elevation) % 100 = 0 THEN elevation END"/>
    ...
    <property key="labeling/textColorG" value="83"/>
    <property key="labeling/textColorR" value="123"/>
