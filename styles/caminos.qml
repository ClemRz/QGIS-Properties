...
<qgis version="2.12.1-Lyon" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{1fba0cf9-34d6-49bd-afa9-49cbc7ba6a12}">
      <rule filter="upper(tipo) = 'TERRACERIA'" key="{83bc9b9f-4d59-4003-bf33-8623325531d5}" symbol="0" label="Terracería"/>
      <rule filter="upper(tipo) = 'VEREDA'" key="{5c58228f-0be0-4a70-bfc1-c33299ae0748}" symbol="1" label="Vereda"/>
      <rule filter="upper(tipo) = 'BRECHA'" key="{c7319a8c-6a87-47e7-86ba-95db466d1ecd}" symbol="2" label="Brecha"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="1">
          ...
          <prop k="line_width" v="0.229885"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0.45977"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="1">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="customdash" v="2.3;0.46"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="customdash_unit" v="MM"/>
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="76,75,75,255"/>
          <prop k="line_style" v="dash"/>
          <prop k="line_width" v="0.229885"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="2">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="1.15;1.26"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="customdash_unit" v="MM"/>
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="156,155,155,255"/>
          <prop k="line_style" v="dash"/>
          <prop k="line_width" v="0.229885"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="tipo"/>
