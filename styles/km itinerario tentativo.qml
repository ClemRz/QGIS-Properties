...
<qgis version="2.18.24" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="SL_ID">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="SL_SEGMENT">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="SL_ANGLE">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="SL_LENGTH">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="SL_ORIENT">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="concat(SL_ID)"/>
    ...
    <property key="labeling/shadowBlendMode" value="5"/>
    ...
    <property key="labeling/shapeBorderWidth" value="0.8"/>
  ...
  <aliases>
    ...
    <alias field="SL_ID" index="1" name=""/>
    <alias field="SL_SEGMENT" index="2" name=""/>
    <alias field="SL_ANGLE" index="3" name=""/>
    <alias field="SL_LENGTH" index="4" name=""/>
    <alias field="SL_ORIENT" index="5" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="SL_ID"/>
      <column width="-1" hidden="0" type="field" name="SL_SEGMENT"/>
      <column width="-1" hidden="0" type="field" name="SL_ANGLE"/>
      <column width="-1" hidden="0" type="field" name="SL_LENGTH"/>
      <column width="-1" hidden="0" type="field" name="SL_ORIENT"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="SL_ID" expression=""/>
    <default field="SL_SEGMENT" expression=""/>
    <default field="SL_ANGLE" expression=""/>
    <default field="SL_LENGTH" expression=""/>
    <default field="SL_ORIENT" expression=""/>
  </defaults>
