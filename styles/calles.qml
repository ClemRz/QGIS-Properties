...
<qgis version="2.12.1-Lyon" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{09a3a02a-1ab1-4b52-9c10-7fc259c8747d}">
      <rule scalemaxdenom="26000" filter="upper(TIPO) = 'CALLE DE PRIMER ORDEN'" key="{44bdd9fa-f258-44da-be0f-249e137c0547}" symbol="0" scalemindenom="1" label="Calle principal, nombre de calle"/>
      <rule scalemaxdenom="1000000" key="{44bdd9fa-f258-44da-be0f-249e137c0547}" symbol="1" scalemindenom="26000" label="Calle"/>
      <rule scalemaxdenom="26000" filter="upper(TIPO) != 'CALLE DE PRIMER ORDEN'" key="{b38cf398-b98b-4e64-8f04-cfa5f98c355f}" symbol="2" scalemindenom="1" label="Calle, nombre de calle"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="1">
          ...
          <prop k="line_color" v="105,105,105,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1.26437"/>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/LabelDistance" value="1~~1~~CASE WHEN upper(TIPO) = 'CALLE DE PRIMER ORDEN' THEN -1.149425 ELSE 0 END~~"/>
    ...
    <property key="labeling/fieldName" value="CASE WHEN upper(NOMBRE) != 'NINGUNO' THEN upper(NOMBRE) END"/>
    ...
    <property key="labeling/scaleMax" value="26000"/>
    <property key="labeling/scaleMin" value="500"/>
