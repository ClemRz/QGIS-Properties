...
<qgis version="2.18.24" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color" v="150,150,150,130"/>
  ...
  <aliases>
    ...
    <alias field="CODIGO" index="1" name=""/>
    <alias field="CARTA" index="2" name=""/>
    <alias field="CALI_REPR" index="3" name=""/>
    <alias field="IDENTIFICA" index="4" name=""/>
    <alias field="CVE_LOC" index="5" name=""/>
    <alias field="NOMBRE" index="6" name=""/>
    <alias field="CVE_MUN" index="7" name=""/>
    <alias field="CVE_EDO" index="8" name=""/>
    <alias field="NUME_HAB" index="9" name=""/>
    <alias field="TIPO" index="10" name=""/>
  </aliases>
